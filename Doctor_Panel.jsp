<%-- 
    ...
    Created on : 19 Nov, 2020, 1:30:54 PM
    Author     : Dell
--%>
...
<nav>
<ul class="ul-list">
<li class="active"><a href="Doctor_Panel.jsp">Home</a></li>
<li><a href="Checkup_view.jsp">CheckupDetails</a>

<div class="sub-list">
<ul>
<li><a href="Checkup_details.jsp">Add</a>

</li>
<li><a href="Checkup_view.jsp">View</a>
</li>
</ul>
</div>
...
<div class="sub-list">
<ul>
    <li><a href="Doctor_Disease.jsp">Add</a>
</li>
...
<div class="sub-list">
<ul>
<li><a href="Doctor_Medicine.jsp">Add</a>
