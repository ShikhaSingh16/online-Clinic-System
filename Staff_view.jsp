...
<td><center><b>PhoneNo</b></center></td>
...
String sql ="select * from Add_Staff";
...
<td><center><%=resultSet.getString("Qualifications") %></center></td>
<td><center><%=resultSet.getString("Role") %></center></td>
